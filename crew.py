...
if __name__ == "__main__":
    ...
    inputs = {
        "product_name": "Varun's Advanced AI powered Data Tool",
        "target_audience": "Small and Medium Enterprises (SMEs)",
        "product_description": "A tool that automates repetitive Data Analysis,Data Cleaning and creating dashboards tasks using AI, saving time and reducing errors.",
        "budget": "$ 5000",
